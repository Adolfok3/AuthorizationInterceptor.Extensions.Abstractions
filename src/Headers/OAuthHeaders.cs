...
{
    /// <summary>
    /// Represents an OAuth authentication headers containing details about an access token and its properties.
    /// </summary>
    ...
    public record OAuthHeaders(string AccessToken, string TokenType, double? ExpiresIn = null, string? RefreshToken = null, string? Scope = null);
}
